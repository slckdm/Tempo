...
# Events RK
# - Management
UPLOAD_CREATED_EVENT_RK = RoutingKey("tempo.mng.upload.created")
UPLOAD_COMPLETED_EVENT_RK = RoutingKey("tempo.mng.upload.completed")
UPLOAD_DELETED_EVENT_RK = RoutingKey("tempo.mng.upload.deleted")
# - Metadata
